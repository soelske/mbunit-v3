...
namespace Gallio.Icarus
{
    ...
    public static class Paths
    {
        ...
        /// DockPanel3.config is used instead of DockPanel.config to avoid loading an incompatible
        /// v2 layout file written by the old .NET Framework Icarus (DockPanelSuite v2 vs v3 schema mismatch).
        /// </summary>
        public static string DockConfigFile = Path.Combine(IcarusAppDataFolder, @"DockPanel3.config");
