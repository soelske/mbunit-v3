...
namespace Gallio.Runner.Projects.Schema
{
    ...
    public sealed class TestProjectData : IValidatable
    {
            ...
            : this()
        {
            ...
            if (source.IsTestRunnerFactoryNameSpecified)
                testRunnerFactoryName = source.TestRunnerFactoryName;
        ...
        /// <summary>
        /// Gets or sets the test runner factory name stored in this project, or null if not specified.
        /// </summary>
        [XmlElement("testRunnerFactoryName")]
        public string TestRunnerFactoryName
        {
            get { return testRunnerFactoryName; }
            set { testRunnerFactoryName = value; }
        }
        ...
        public void InitializeTestProject(TestProject testProject)
        {
            ...
            if (testRunnerFactoryName != null)
                testProject.TestRunnerFactoryName = testRunnerFactoryName;
