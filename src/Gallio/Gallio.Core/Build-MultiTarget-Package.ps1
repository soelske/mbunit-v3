...
$gallioRoot = Join-Path $srcRoot "Gallio"
...
$iconPath = Join-Path $gallioRoot "Gallio\Resources\Pillar.png"
...
<Project Sdk="Microsoft.NET.Sdk">
  <PropertyGroup>
    ...
    <Description>$PackageId Test Automation Platform v4 - Multi-target package supporting .NET Framework 3.5+ and .NET 8</Description>
    ...
    <PackageIcon>Pillar.png</PackageIcon>
  </PropertyGroup>
