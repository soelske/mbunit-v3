...
namespace Gallio.Common.Remoting
{
    ...
    {
        /// <summary>
        /// Gets the type of the remote exception.
        /// </summary>
        ...
        public RpcException(string message, string remoteExceptionType) : base(message)
        {
        ...
        public RpcException(string message, string remoteExceptionType, Exception innerException) 
