...
namespace Gallio.Icarus.Controllers
{
    public class OptionsController : NotifyController, IOptionsController,
        Handles<ProjectLoaded>, Handles<ProjectSaved>, Handles<SavingProject>
    {
        ...
        public void Handle(ProjectLoaded @event)
        {
            ...
            var testProject = projectTreeModel.TestProject;
            if (testProject != null && testProject.IsTestRunnerFactoryNameSpecified)
                TestRunnerFactory.Value = testProject.TestRunnerFactoryName;
        }
        ...
        {
            if (projectTreeModel.TestProject != null && TestRunnerFactory.Value != null)
                projectTreeModel.TestProject.TestRunnerFactoryName = TestRunnerFactory.Value;
        }
