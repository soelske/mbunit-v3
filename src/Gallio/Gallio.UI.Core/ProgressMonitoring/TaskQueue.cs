...
namespace Gallio.UI.ProgressMonitoring
{
    ...
    {
        private readonly ConcurrentDictionary<string, Queue<ICommand>> allTasks =
            new ConcurrentDictionary<string, Queue<ICommand>>();
        ...
        {
            return allTasks.GetOrAdd(queueId, _ => new Queue<ICommand>());
        }
